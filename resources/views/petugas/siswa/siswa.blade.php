        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <h5 class="hk-sec-title">Data Siswa {{ $kelas }}</h5>
                            ...
                            <div class="my-2">
                                <form action="">
                                    <select class="form-control" name="kelas">
                                        <option {{ !$kelasid ? 'selected' : '' }} value="">Semua Kelas</option>
                                        @foreach ($classes as $class)
                                            <option value="{{ $class->id_kelas }}"
                                                {{ $kelasid === $class->id_kelas ? 'selected' : '' }}>
                                                {{ $class->jenis_kelas }}</option>
                                        @endforeach
                                    </select>
                                    @if (request('search'))
                                    ...
                                    <tbody>
                                        @foreach ($siswa as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('siswa.index') }}?kelas={{  $data->id_kelas }}" class="text-primary">
