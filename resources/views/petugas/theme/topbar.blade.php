<nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar green-gr">
    ...
    <a class="navbar-brand" href="">
        <img class="brand-img d-inline-block" src="/{{ config('app.logo') }}" style="height: 40px !important;" alt="brand" />
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-0">
            <li style="visibility: visible !important" class="nav-item timpa-tw {{ (request()->is('petugas/dashboard*')) ? 'active' : '' }}">
                <a href="{{ route('petugas.dashboard') }}" class="nav-link">Dashboard</a>
            </li>
            <li style="visibility: visible !important" class="nav-item timpa-tw {{ (request()->is('petugas/peminjaman*')) ? 'active' : '' }}">
                <a href="{{ route('peminjaman.index') }}" class="nav-link">Peminjaman Buku</a>
            </li>
            <li style="visibility: visible !important" class="nav-item timpa-tw {{ (request()->is('petugas/pengembalian*')) ? 'active' : '' }}">
                <a href="{{ route('pengembalian.index') }}" class="nav-link">Pengembalian Buku</a>
            </li>
            <li style="visibility: visible !important" class="nav-item timpa-tw {{ (request()->is('petugas/laporan*')) ? 'active' : '' }}">
