...
class KepsekPetugasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', 'Berhasil Menambahkan Data Kepala Perpustakaan');
    }
    ...
    public function update(Request $request, $id)
    {
        if ($request->foto_kepsek == NULL) {
            ...
            return back()->with('success', 'Berhasil Memperbaharui Data Kepala Perpustakaan');
        }
    ...
    public function destroy($id)
    {
        ...
        return back()->with('success', 'Berhasil Menghapus Data Kepala Perpustakaan');
    }
}
