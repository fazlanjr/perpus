...
// Route::get('/user', function (Request $req, Response $response) {
//     return $response->json('msg','jepi');
// });
...
Route::middleware(['auth', 'user-access:Petugas'])->group(function () {
    ...
    Route::get('/petugas/dashboard/show', [DashboardPetugasController::class, 'show'])->name('petugas.get');
    Route::get('/petugas/dashboard/sipaling', [DashboardPetugasController::class, 'most'])->name('petugas.sipaling');
